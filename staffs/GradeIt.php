...
?>
      <tr>
        <td><?php echo $i++; ?></td>
        <td><a href="studentPage.php?id=<?php echo $row['id'] ?>" style="color:black"><?php echo $row['student_id'] ?></a></td>
        <td><a href="studentPage.php?id=<?php echo $row['id'] ?>" style="color:black"><?php echo $row['assignment_name'] ?></a></td>
        <td><a href="downloadSubmission.php?id=<?php echo $row['id'] ?>" style="color:black"><i class="fa-solid fa-download" ></i></a></td>
        <td><form action="gradeNow.php?id=<?php echo $row['id']?>" method="POST">
