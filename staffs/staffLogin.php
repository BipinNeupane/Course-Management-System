...
if (isset($_POST['submit'])) {
    ...
    $staff_id = $_POST["university-id"];
    $password = $_POST["password"];

    // Build the SELECT query with a WHERE condition
    $data = selectData('staff', '*', "staff_id = '$staff_id' AND password = '$password'");
    if (!empty($data)) {
        ...
        header("Location:myStaffPage.php");
        exit();
    } else {
...
<body>
	<div class="login-container">
		...
		<div class="login-box">
			<img src="../students/wuclogo.png" alt="University Logo">
			<h2>WUC Login</h2>
			<form action="staffLogin.php" method="POST">
				<div class="input-container">
					<input type="text" id="university-id" name="university-id" placeholder="Staff ID" required>
				</div>
				<div class="input-container">
