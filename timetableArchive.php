...
<head>
    ...
    <title>Archived Timetable</title>
    <style>
...
<label for="menu-toggle" id="hamburger">
  ...
  <span></span>
      ...
      <h1 class="my-courses">Archived Timetable</h1>
      <div class="filter">
...
<table>
  ...
  <tbody>
    <?php foreach($timetableData as $data): ?>
      ...
      <td><a href="unarchiveTimetable.php?id=<?php echo $data['timetable_id']?>"><i class="fa fa-archive"></i></a></td>
      </tr>
    <?php endforeach; ?>
  </tbody>
</table>
