...
<label for="menu-toggle" id="hamburger">
  ...
  <span></span>
      ...
      <h1 class="my-courses">Archived Course</h1>
    ...
    <div class="card-container">
      <!-- Course card 1 -->
      <?php 
     $data = selectData("course", "*","status = 0");
         foreach ($data as $row) {
            ?>
     <a href="coursePage.php?id=<?php echo $row['course_id']?>"> <div class="card">
        ...
        <div style="display:flex; flex-direction=row;">
         ...
         <a href="unarchiveCourse.php?id=<?php echo $row['course_id']?>" style="color:green; margin-left:12px;"><div><i class="fa fa-archive"></i></div></a>
      </div>
         </div></a>
      <?php 
} 
